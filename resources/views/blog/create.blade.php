...
@section('content')
    ...
    <div class="w-4/5 m-auto pt-20">
        <form action="/blog" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="title" placeholder="Title" class="bg-gray-100 block border-b-2 w-full h-20 text-6xl outline-none">

            <textarea class="bg-gray-100 py-20 block border-b-2 w-full h-60 text-xl outline-none" name="description" placeholder="Description" id="" cols="30" rows="10"></textarea>
